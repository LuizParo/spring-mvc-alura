...
public class AppWebConfiguration extends WebMvcConfigurerAdapter {
	...
	configurer.enable(); // Deixa passar requisições default (CSS, JavaScript, etc).
    }
    
    @Override
    public void addInterceptors(InterceptorRegistry registry) {
	registry.addInterceptor(new LocaleChangeInterceptor()); // Para que a aplicação possa ser internacionalizada via menu.
    }
    
    @Bean
    public LocaleResolver localeResolver() {
	return new CookieLocaleResolver(); // Para guardar o Local escolhido em um cookie.
    }
