...
public class ProdutoDao {
	...
	TypedQuery<BigDecimal> query = manager.createQuery("select sum(preco.valor) from Produto p join p.precos preco where preco.tipoPreco = :tipoPreco", BigDecimal.class);
