...
<header role="banner" class="cabecalhoPrincipal container">
	<h1 class="cabecalhoPrincipal-titulo">
		<a tabindex="1" href="/" class="cabecalhoPrincipal-linkTitulo"> <svg
	...
	<div id="navegacaoCabecalho" class="cabecalhoPrincipal-navegacao">
		<div class="cabecalhoPrincipal-categoriasEBusca" role="presentation">
			<nav role="navigation" aria-label="Categorias de livros"
				...
				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/todos" class="colecoesDaCDC-colecaoLink">
						<fmt:message key="navegacao.categoria.todos" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/livros-de-agile"
					class="colecoesDaCDC-colecaoLink"> <fmt:message key="navegacao.categoria.agile" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/livros-de-front-end"
					class="colecoesDaCDC-colecaoLink"> <fmt:message key="navegacao.categoria.front_end" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/livros-de-games"
					class="colecoesDaCDC-colecaoLink"> <fmt:message key="navegacao.categoria.games" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/livros-de-java"
					class="colecoesDaCDC-colecaoLink"> <fmt:message key="navegacao.categoria.java" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/livros-de-mobile"
					class="colecoesDaCDC-colecaoLink"> <fmt:message key="navegacao.categoria.mobile" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/livros-desenvolvimento-web"
					class="colecoesDaCDC-colecaoLink"> <fmt:message key="navegacao.categoria.web" /> </a></li>

				<li class="colecoesDaCDC-colecaoItem"><a
					href="/collections/outros" class="colecoesDaCDC-colecaoLink">
			...
			<form role="search" aria-labelledby="rotuloBuscaPrincipal"
				...
				<!-- 
				 -->
				<button class="buscaPrincipal-submit" type="submit">Buscar
				</button>
			</form>
		</div>
		...
		</a> <a tabindex="3" href="${s:mvcUrl('CCC#itens').build()}" title="Ir para sacola de compras"
		...
		<security:authorize access="isAuthenticated()">
			<a tabindex="3" href="${s:mvcUrl('PC#listar').build()}"
			...
			<a tabindex="3" href="${s:mvcUrl('PC#form').build()}"
			...
			<a tabindex="3" href="?locale=pt" title="Cadastro de Produtos" class="sacola cabecalhoPrincipal-itemNavegacao">
				<fmt:message key="menu.pt" />
			</a>
			<a tabindex="3" href="?locale=en_US" title="Cadastro de Produtos" class="sacola cabecalhoPrincipal-itemNavegacao">
